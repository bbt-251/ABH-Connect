...
//                                 <div
//                                     key={step.id}
//                                     className={`flex flex-col items-center ${step.id === currentStep ? "text-[#0a3141]" : "text-gray-500"
//                                         }`}
//                                 >
//                                     <div
//                                         className={`w-10 h-10 rounded-full flex items-center justify-center border-2 ${step.id === currentStep ? "border-[#d2f277] bg-[#d2f277] text-black" : "border-gray-300"
//                                             }`}
//                                     >
