                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4">
                        {domains.map((domain) => (
                            <div
                                ...
                                className={`p-4 rounded-lg border cursor-pointer transition-all hover:shadow-md ${selectedDomain === domain.name
                            ...
                            >
                                <div className="text-center">
                                    ...
                                    <span
                                        className={`text-xs font-medium px-2 py-1 rounded-full ${selectedDomain === domain.name ? "bg-white/20 text-white" : "bg-gray-100 text-gray-600"
                                            }`}
                                    >
                    ...
                    <div className="flex-1">
                        ...
                        <div className="space-y-4">
                            {filteredJobs.map((job) => (
                                <div
                                    key={job.id}
                                    className={`bg-white p-6 rounded-lg shadow-sm border cursor-pointer transition-all hover:shadow-md ${selectedJob?.id === job.id ? "border-[#0a3141] bg-blue-50" : "border-gray-100"
                                        }`}
